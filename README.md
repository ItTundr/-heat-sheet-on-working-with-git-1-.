...
### В случае когда надо внести правки в уже сделанный коммит это можно сделать с помощью опции --amend (от англ. amend — «исправить», «дополнить») у команды commit: **git commit --amend** 

(-m"") надо ввести сообщение

(--no-edit) сообщение ненужно менять 

### вы знаете, как сделать шаг назад, если что-то пошло не так. Вот о чём мы рассказали:
